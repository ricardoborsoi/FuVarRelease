function [Out,W_hyper,H_hyper,W_multi,H_multi] = CNMF_fusion2(HSI,MSI,R_est,M_em,mask)
%--------------------------------------------------------------------------
...
%
% --------------------------
% Added: input of the a priori known SRF given by R_est.
%--------------------------------------------------------------------------
...
% ----------------------
% override R with version given a priori
R = R_est;
% ----------------------
