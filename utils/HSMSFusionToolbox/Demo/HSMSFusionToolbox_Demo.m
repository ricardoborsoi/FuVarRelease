...
scaling = 10000;
toolbox_path = '~/Documents/RESEARCH_PARENT/RESEARCH_PARENT_cloud/THINGS_WORKING(ED)/SRR_Fusion_HSI_Variability/'; %'./'; % path where you put HSMSFusionToolbox
data_path = [toolbox_path 'HSMSFusionToolbox/Data/HyperspecVNIRChikusei/'];

addpath(genpath([toolbox_path 'HSMSFusionToolbox']))
