% =========================================================================
% This code corresponds to the example with the Lake Tahoe image contained
...
% % ------------------------------------
% Run VCA on HSI and use FCLS for initialization
...
% print(['examples/recIm_ex3a_Tahoe_vis'],'-dpdf')
...
% print(['examples/recIm_ex3a_Tahoe_IR'],'-dpdf')
...
figure;
[ha, pos] = tight_subplot(2, 5, [0.01 0.01], 0.25, 0.15);
...
% print(['examples/recIm_ex3a_Tahoe_vis_IR'],'-dpdf')
...
ylabel('PSNR [dB]')
% print(['examples/PSNR_band_ex3a_Tahoe'],'-dpdf')
...
set(h,'fontsize',12);
% print(['examples/SAM_map_ex3a_Tahoe'],'-dpdf')
